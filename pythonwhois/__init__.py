...
def get_whois(domain, normalized=[], proxy_opener=None, whois_server_cache=None):
	raw_data, server_list = net.get_whois_raw(domain, with_server_list=True, proxy_opener=proxy_opener, whois_server_cache=whois_server_cache)
